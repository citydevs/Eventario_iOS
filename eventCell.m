...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
       ...
       // [self addSubview:circleView];
        ...
        [_nombre setFont:[UIFont fontWithName:@"OpenSans-Bold" size:44]];
        _nombre.numberOfLines = 3;
        
        [self   addSubview:_nombre];
        
        _hora=[[UILabel alloc]initWithFrame:CGRectMake(80, 60, 300, 34)];
        _hora.textColor=[UIColor grayColor];//[UIColor colorWithRed:(7/255.0) green:(104/255.0) blue:(239/255.0) alpha:1];
        //[_hora setFont:[UIFont systemFontOfSize:10]];
        [_hora setFont:[UIFont fontWithName:@"NIISans" size:12]];
                [self   addSubview:_hora];
       
        _distancia=[[UILabel alloc]initWithFrame:CGRectMake(260, 60, 70, 34)];
        _distancia.text=@"300 m";
        _distancia.textColor=[UIColor grayColor];//[UIColor colorWithRed:(7/255.0) green:(104/255.0) blue:(239/255.0) alpha:1];
        // [_distancia setFont:[UIFont systemFontOfSize:14]];
        [_distancia setFont:[UIFont fontWithName:@"NIISans" size:12]];
